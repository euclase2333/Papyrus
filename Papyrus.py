...
class NovelWriter(QMainWindow):
    ...
    def qss_day(self):
        ...
        * { font-family:"Segoe UI","Microsoft YaHei","微软雅黑",sans-serif; font-size:15px; }
        #FontSizeCombo, #FontFamilyCombo, #ExportButton { font-size:16px; }
        ...
        #FontSizeCombo, #FontFamilyCombo {
            background:#FFFFFF; color:#222222; border:1px solid #D9DEE5;
            border-radius:7px; padding:8px 28px 8px 11px; min-height:22px;
        }
        #FontSizeCombo:hover, #FontFamilyCombo:hover { border-color:#AEB7C5; }
        #FontSizeCombo:focus, #FontFamilyCombo:focus { border-color:#9AA9BF; }
        #FontSizeCombo::drop-down, #FontFamilyCombo::drop-down {
            width: 24px; border: none; background: transparent;
        }
        #FontSizeCombo::down-arrow, #FontFamilyCombo::down-arrow {
